import {
  ...
  cilUserUnfollow,
  cilTruck,
    cilPlus, // <-- Add this line
    cilBan, // <-- Add this line for cancel icon
    cilXCircle, // <-- Add this line for red cross cancelled icon
} from '@coreui/icons';
...
export enum IconSubset {
  ...
  cilTruck = 'cilTruck',
  cilPlus = 'cilPlus', // <-- Add this line
  cilBan = 'cilBan', // <-- Add this line for cancel icon
  cilXCircle = 'cilXCircle', // <-- Add this line for red cross cancelled icon
}
